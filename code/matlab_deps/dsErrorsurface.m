function pp = dsErrorsurface(x, y, e, surfaceColor, surfaceAlpha)
%DSERRORSURFACE - Error surface plot.
%
%   pp = dsErrorsurface(x, y, e, [surfaceColor], [surfaceAlpha])
%
...
pp = patch(X,Y,surfaceColor);
set(pp,'FaceAlpha', surfaceAlpha, ...
